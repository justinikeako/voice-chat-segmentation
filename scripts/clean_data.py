...
def clean_dataset():
    print(f"[Kera AI] Starting COMPREHENSIVE data cleaning...")
    ...
    # Look through all 12 folders (1A, 1B, 2C, 3C, 4A, etc.)
    for folder_name in sorted(os.listdir(RAW_DATA_DIR)):
        ...
        # Count how many are already in the clean folder (in case you stop and restart the script)
        ...
        for filename in os.listdir(raw_folder_path):
            ...
            # If we already copied this exact file in a previous run, skip it
            ...
            try:
                ...
                # The New, Comprehensive Prompt with folder context
                prompt = (
                    ...
                    f"1. It does NOT match the {folder_name.upper()} ({hair_desc}) hair texture.\n"
                ...
                if "NO" in decision:
                    ...
                    # COPY the file to the clean folder instead of modifying the raw folder
                ...
                # Pause for 1.5 seconds to protect your Azure API rate limits
                time.sleep(1.5)
    ...
    print("\n[Kera AI] ✅ Comprehensive data cleaning complete! Your production-grade dataset is ready.")
